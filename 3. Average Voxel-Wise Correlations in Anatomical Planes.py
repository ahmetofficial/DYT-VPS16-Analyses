...
data_efield_filtered                     = utils_VAT.assign_efields_to_voxels(data_efield_filtered, voxel_size=0.25)
...
xz_plane_r  = utils_VAT.create_2D_plane_for_correlation_values(data_corr, hemisphere="right", plane_axis='xz', constant=-8)
...
xz_plane_l  = utils_VAT.create_2D_plane_for_correlation_values(data_corr, hemisphere="left", plane_axis='xz', constant=-8)
...
if(hemisphere=="right"):
    ...
    if(plane=="xy"):
        ...
        plotter.add_mesh(xy_plane_r, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
        plotter.camera_position = (0.0, 0.0, 1.0)
        
    elif(plane=="yz"):
        # right hemisphere YZ plane
        plotter.add_mesh(yz_plane_r, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
        plotter.camera_position = (-1.0, 0.0, 0.0)
        
    elif(plane=="xz"):
        # right hemisphere XZ plane
        plotter.add_mesh(xz_plane_r, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
    ...
    if(plane=="xy"):
        ...
        plotter.add_mesh(xy_plane_l, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
        plotter.camera_position = (0.0, 0.0, 1.0)
        
    elif(plane=="yz"):
        # left hemisphere YZ plane
        plotter.add_mesh(yz_plane_l, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
        plotter.camera_position = (1.0, 0.0, 0.0)
    
    elif(plane=="xz"):
        # left hemisphere XZ plane
        plotter.add_mesh(xz_plane_l, scalars='correlation', cmap=cmap, point_size=5, render_points_as_spheres=False, clim=clim)
        plotter.camera_position = (0.0, -1.0, 0.0)
